...
- Create Angular project with ng: `ng new angularaspapptest.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularaspapptest.client.esproj`).
